...
//	private boolean photograph;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int recogcamera_layout_id = getResources().getIdentifier("wintone_camera_opt", "layout", this.getPackageName());
		...
		if (null != authfile && !authfile.equals("") && authfile.equals("guangda")) {
			if (deviceId.equals("null")) {
				authfile = getExtPath() + "/wintone/" + androidId + "_cp.txt";
			} else {
				authfile = getExtPath() + "/wintone/" + deviceId + "_cp.txt";
			}
			Log.i(TAG, "authfile =" + authfile);
		}
	...
	protected void onStart() {
		...
		if (isCatchPicture) {
			...
			// lpFileName = sdDirString +"/plateid"+datetime+".jpg";
