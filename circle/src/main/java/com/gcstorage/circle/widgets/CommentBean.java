...
public class CommentBean {
    ...
    public void build(Context context) {
        if (commentType == Constants.CommentType.COMMENT_TYPE_SINGLE) {
            commentContentSpan = Utils.makeSingleCommentSpan(context, childUserName, commentContent);
        } else {
            commentContentSpan = Utils.makeReplyCommentSpan(context, parentUserName, childUserName, commentContent);
        }
    }
}
